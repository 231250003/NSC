...
funcDef : funcType IDENT L_PAREN (funcFParams)? R_PAREN (SEMICOLON | block);

funcType : VOID | INT;

funcFParams : funcFParam (COMMA funcFParam)*;

funcFParam : bType IDENT (L_BRACKT number R_BRACKT)*;
...
stmt
   ...
   | FOR L_PAREN (varDecl | ( (exp)? SEMICOLON))  ((cond)? SEMICOLON) ((lVal ASSIGN exp )?) R_PAREN stmt
   | BREAK SEMICOLON
   | CONTINUE SEMICOLON
