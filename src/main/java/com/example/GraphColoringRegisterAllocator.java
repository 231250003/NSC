        ...
        for (LLVMBasicBlockRef bb = LLVM.LLVMGetFirstBasicBlock(func); bb != null && !bb.isNull(); bb = LLVM.LLVMGetNextBasicBlock(bb)){
           ...
           while(instr!=null){
                if(LLVM.LLVMGetInstructionOpcode(instr)==LLVM.LLVMGetElementPtr){
                    ...
                    if(LLVM.LLVMIsAGlobalVariable(LLVM.LLVMGetOperand(instr, 0))!=null){
        ...
        do {
            ...
            for (LLVMBasicBlockRef bb = LLVM.LLVMGetFirstBasicBlock(func); bb != null && !bb.isNull(); bb = LLVM.LLVMGetNextBasicBlock(bb)) {
                ...
                for (int i = 0; i < numSuccessors; i++) {
                    ...
                    System.out.println(LLVMGetValueName(func));
        ...
        for (LLVMBasicBlockRef bb = LLVM.LLVMGetFirstBasicBlock(func); bb != null && !bb.isNull(); bb = LLVM.LLVMGetNextBasicBlock(bb)) {
            ...
            while (instr != null) {
                ...
                if(LLVM.LLVMGetInstructionOpcode(instr)==LLVM.LLVMCall||LLVM.LLVMGetInstructionOpcode(instr)==LLVMLoad){
                    int argCount=1;
                    if(LLVM.LLVMGetInstructionOpcode(instr)==LLVM.LLVMCall) argCount = LLVM.LLVMGetNumArgOperands(instr);
                    for (int i = 0; i < argCount; i++) {
