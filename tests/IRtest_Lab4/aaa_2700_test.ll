...
while.cond:                                       ; preds = %merge99, %mainEntry
...
cur32:                                            ; preds = %if.then45, %while.cond34
...
while.cond34:                                     ; preds = %if.then45, %if.then45, %if.then45, %if.then29
