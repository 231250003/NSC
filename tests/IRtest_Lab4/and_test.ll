...
cur:                                              ; preds = %if.then24, %while.cond
  br label %merge
...
if.then17:                                        ; preds = %and.merge
  ...
  %g19 = call i32 @g(i32 10, i32 2)
  br label %while.cond
  br label %merge7

merge20:                                          ; preds = %if.then24, %merge7
  br label %while.cond

if.then24:                                        ; preds = %merge7
  br label %cur
  br label %merge20
}
