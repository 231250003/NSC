...
cur6:                                             ; preds = %if.else33, %while.cond12
...
while.cond12:                                     ; preds = %merge13, %merge19, %if.then
  br i1 %to_bool10, label %while.stmt11, label %cur6

merge13:                                          ; preds = %merge28, %merge19
  br label %while.cond12

if.then17:                                        ; preds = %while.stmt11
