...
mainEntry:
  ...
  %load_lval = load [2 x i32], [2 x i32]* %a, align 4
  %load_lval5 = load [3 x i32], [3 x i32]* %b, align 4
  %combine = call i32 @combine([2 x i32] %load_lval, i32 2, [3 x i32] %load_lval5, i32 3)
  ret i32 %combine
}
