...
mainEntry:
  ...
  br i1 %to_bool, label %if.then, label %while.stmt
...
if.then:                                          ; preds = %mainEntry
  ...
  br i1 %to_bool10, label %if.then9, label %while.stmt
...
while.stmt:                                       ; preds = %if.then22, %if.else, %if.then, %mainEntry
  ...
  br i1 %to_bool17, label %cur, label %if.else
...
if.else:                                          ; preds = %while.stmt
  ...
  br i1 %to_bool23, label %if.then22, label %while.stmt
...
while.stmt29:                                     ; preds = %while.cond30
  ...
  br i1 %to_bool40, label %cur28, label %if.else50
...
merge55:                                          ; preds = %if.then68, %if.else60, %if.then59
...
if.else60:                                        ; preds = %if.else50
  ...
  br i1 %to_bool69, label %if.then68, label %merge55
...
merge72:                                          ; preds = %if.then87, %if.then78
