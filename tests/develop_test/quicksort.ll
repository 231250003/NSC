...
define i32 @swap2([6 x i32]* %arr, i32 %i, i32 %j) {
swap2Entry:
  %param1_addr = alloca i32, align 4
  store i32 %i, i32* %param1_addr, align 4
  %param2_addr = alloca i32, align 4
...
mainEntry:
  ...
  %swap2 = call i32 @swap2([6 x i32]* %elemPtr6, i32 2, i32 5)
  store i32 %swap2, i32* %x, align 4
  %load_lval = load i32, i32* %x, align 4
  %elemPtr7 = getelementptr [6 x i32], [6 x i32]* %arr, i32 0, i32 3
  %load_lval8 = load i32, i32* %elemPtr7, align 4
  %add = add i32 %load_lval, %load_lval8
  ret i32 %add
}
