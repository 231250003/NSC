...
define i32 @partition([2 x i32]* %arr, i32 %low, i32 %high) {
partitionEntry:
  %param1_addr = alloca i32, align 4
...
cur:                                              ; preds = %for.cond
  %elemPtr19 = getelementptr [2 x i32], [2 x i32]* %arr, i32 0
  %load_lval20 = load i32, i32* %i, align 4
  %add21 = add i32 %load_lval20, 1
  %load_lval22 = load i32, i32* %param2_addr, align 4
  call void @swap([2 x i32]* %elemPtr19, i32 %add21, i32 %load_lval22)
...
for.stmt:                                         ; preds = %for.cond
  ...
  %elemPtr7 = getelementptr [2 x i32], [2 x i32]* %arr, i32 0, i32 %load_lval6
...
if.then:                                          ; preds = %for.stmt
  ...
  %elemPtr14 = getelementptr [2 x i32], [2 x i32]* %arr, i32 0
  %load_lval15 = load i32, i32* %i, align 4
  %load_lval16 = load i32, i32* %j, align 4
  call void @swap([2 x i32]* %elemPtr14, i32 %load_lval15, i32 %load_lval16)
  br label %merge
}

define void @quickSort([2 x i32]* %arr, i32 %low, i32 %high) {
quickSortEntry:
  %param1_addr = alloca i32, align 4
  store i32 %low, i32* %param1_addr, align 4
  %param2_addr = alloca i32, align 4
...
if.then:                                          ; preds = %quickSortEntry
  ...
  %elemPtr = getelementptr [2 x i32], [2 x i32]* %arr, i32 0
  %load_lval2 = load i32, i32* %param1_addr, align 4
  %load_lval3 = load i32, i32* %param2_addr, align 4
  %partition = call i32 @partition([2 x i32]* %elemPtr, i32 %load_lval2, i32 %load_lval3)
  store i32 %partition, i32* %pi, align 4
  %elemPtr4 = getelementptr [2 x i32], [2 x i32]* %arr, i32 0
  %load_lval5 = load i32, i32* %param1_addr, align 4
  %load_lval6 = load i32, i32* %pi, align 4
  %sub = sub i32 %load_lval6, 1
  call void @quickSort([2 x i32]* %elemPtr4, i32 %load_lval5, i32 %sub)
  %elemPtr7 = getelementptr [2 x i32], [2 x i32]* %arr, i32 0
  %load_lval8 = load i32, i32* %pi, align 4
  %add = add i32 %load_lval8, 1
  %load_lval9 = load i32, i32* %param2_addr, align 4
  call void @quickSort([2 x i32]* %elemPtr7, i32 %add, i32 %load_lval9)
  br label %merge
}
