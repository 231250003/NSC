...
while.cond:                                       ; preds = %merge17, %mainEntry
  ...
  br i1 %to_bool, label %while.stmt, label %while.cond39
...
merge17:                                          ; preds = %if.then30, %if.then21, %if.else
...
if.then21:                                        ; preds = %cur2
  ...
  br i1 %to_bool31, label %if.then30, label %merge17
...
while.cond39:                                     ; preds = %while.cond, %merge44
  ...
  br i1 %to_bool43, label %while.stmt38, label %while.cond67
...
while.cond67:                                     ; preds = %if.else82, %if.then81, %while.cond39
...
while.cond114:                                    ; preds = %if.else135, %if.then134, %if.then124, %if.else105, %if.then104, %if.then93
